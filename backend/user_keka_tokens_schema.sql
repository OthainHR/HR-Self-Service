...
-- Update the scope column to be more descriptive if it exists
-- If scope column is too small, we'll use it as-is
...
-- Create view for token status (without is_active column)
